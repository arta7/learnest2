...
export const convertFullDateAndTime = (
  date,
  options = { second: true, minute: true }
) => {
  const coptions = {
    year: "numeric",
    month: "2-digit",
...
export const checkIosVersion = function () {
...
export const toEnglishDigit = function (txt) {
...
// TODO
export const checkWebview = (locationSearchQuery) => {
  if (getItem("856C9") == "53DA4F4316CA2A2B9B55831A38DE6") {
    return true;
  } else if (
    qs.parse(locationSearchQuery)?.["856C9"] == "53DA4F4316CA2A2B9B55831A38DE6"
  ) {
    setItem("856C9", "53DA4F4316CA2A2B9B55831A38DE6");
    return true;
  }
  return false;
};
