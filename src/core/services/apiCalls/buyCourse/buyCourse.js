...
export const apiCall_deleteInvitement = (body) => {
  return http.post(buyCourse_apis.deleteInvitement, body);
};

export const apiCall_rejectInvitement = (body) => {
  return http.post(buyCourse_apis.rejectInvitement, body);
};

export const apiCall_checkoutRefferCode = (code) => {
  return http.post(buyCourse_apis.checkoutRefferCode + "?refferCode=" + code);
};
