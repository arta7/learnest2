...
export const API_URLs = {
  ...
  leitners: {
    ...
    getCompleteds: baseUrl + "/leitners/getcompleteds",
    addtoleitner: baseUrl + "/leitners/addtoleitner",
    deleteFromleitner: baseUrl + "/leitners/delete",
    updateleitners: baseUrl + "/leitners/updateleitners",
    addSpecificVocabtoLeitner: baseUrl + "/leitners/addspecificvocabtoleitner",
  },
  answerToQuestion: {
  ...
  buyCourse: {
    ...
    invitetoclassroom: baseUrl + "/courses/invitetoclasssroom",
  ...
  course: {
    getInvitedsByUser: baseUrl + "/courses/classroominvitessentbyuser",
  },
  dictionary: {
    search: baseUrl + "/dictionary/details",
  },
  refferer: {
    refferdashboard: baseUrl + "/students/refferdashboard",
    withdrawdashboard: baseUrl + "/students/withdrawdashboard",
    requestwithdraw: baseUrl + "/students/requestwithdraw",
    cancelwithdraw: baseUrl + "/students/cancelwithdraw",
  },
};
