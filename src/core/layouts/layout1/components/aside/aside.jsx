...
import referIcon from "../../../../../assets/img/icons/refer.png";
...
import { BookmarkIcon, NoteIcon, ProfileIcon } from "../../../../../components/icons/icons";
  ...
  return (
    <Drawer classes={rightDrawerClasses} dir="rtl" anchor="right" {...props}>
      ...
      <Dialog open={openHowToUseApp} onClose={handle_openHowToUseApp}>
        ...
        >
          <ReactPlayer controls url={fileBaseUrl + "/tutorials/app.mp4"} />
        </div>
      </Dialog>
      {/* <AppTour page="aside" /> */}
    </Drawer>
