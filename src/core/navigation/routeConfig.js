...
import CompletedLeitners from "../../components/leitners/pages/compeletedLeitners.page";
...
import DeviceCompabilityOutlet from "./deviceCompailityOutlet";
...
///
const OperatingSystemErrorPage = lazy(() => {
  return import(
    "../../pages/operating-system-problem/operatingSystemProblem.page"
  );
});
///
const BrowserProblemPage = lazy(() => {
  return import("../../pages/browser-problem/browserProblem.page");
});
const IosInstallationGuidePage = lazy(() => {
  return import("../../pages/InstallationGuide/iosInstallationGuide.page");
});
const AndroidInstallationGuidePage = lazy(() => {
  return import("../../pages/InstallationGuide/androidInstallationGuide.page");
});
const RefererDashboard = lazy(() =>
  import("../../pages/referer-page/dashboard")
);
const RefererWithdrawal = lazy(() =>
  import("../../pages/referer-page/withdrawal")
);
//
/////BookMarksFoolder
    ...
    <Suspense fallback={<PreLoader />}>
      <Routes>
        ...
        <Route
          ...
          element={<IosInstallationGuidePage />}
        />
        <Route
        ...
        <Route path="/" element={<PrivateOutlet />}>
          ...
          <Route path="/" element={<InClassRoom />}>
            ...
            <Route path="/" element={<WithLayout2 />}>
              <Route path="/referer-dashboard" element={<RefererDashboard />} />
              <Route
                path="/referer-withdrawal"
                element={<RefererWithdrawal />}
              />
              ...
              <Route
                path="/compeleted-leitners/:isVocab"
                element={<CompletedLeitners />}
              />
        ...
        {/* <Route
          ...
          element={<DeviceNotCompatiblePage />}
        /> */}
        {/* <Route path="/test" element={<TextSelectionPage />} /> */}
