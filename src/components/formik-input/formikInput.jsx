...
export const TextInput = ({ label, ...props }) => {
  ...
  return (
    <div
      className={
        (props.holderClassName ? props.holderClassName : "w-100") +
        " formik_input-text m-0 p-0 d-flex flex-column justify-content-start align-items-stretch"
      }
    >
      <label
        dir="rtl"
        className={props.LabelClassName + " mb-2"}
        htmlFor={props.id}
      >
        {label}
      </label>
  ...
  return (
    ...
    >
      ...
      <input
        ...
        className={
          props.inputclassname + " input-border rounded text-input px-3 py-2"
        }
        {...field}
        {...props}
        onChange={(e) => {
