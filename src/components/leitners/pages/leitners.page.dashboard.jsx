    ...
    <section className="m-0 p-3 d-flex flex-column justify-content-start align-items-stretch">
      <div className="m-0 my-3 p-0 d-flex flex-row justify-content-start align-items-center">
        ...
        <Dialog open={openHowToUseLeitner} onClose={handle_openHowToUseLeitner}>
          ...
          >
            <ReactPlayer
              url={fileBaseUrl + "/tutorials/leitner.mp4"}
              controls
            />
          </div>
        </Dialog>
        ...
        <Box sx={{ width: "100%" }}>
          ...
          <TabPanel value={value} index={0}>
            ...
            >
              ...
              {/*  */}
              <div className="my-3 mt-5 mb-2 m-0 p-0  d-flex flex-row justify-content-center align-items-center">
                <Button
                  variant="contained"
                  color="primary"
              ...
              <div className="my-3 mt-2 m-0 p-0 d-flex flex-row justify-content-center align-items-center">
                <Button
                  variant="contained"
                  color="primary"
                  onClick={() => {
                    navigate("/compeleted-leitners/true");
                  }}
                  className="w-100 py-3"
                >
                  مشاهده لغات تکمیل شده
                </Button>
              </div>
            </div>
            {/*********/}
          ...
          <TabPanel value={value} index={1}>
            ...
            >
              ...
              <div className="my-3 mb-2 mt-5 m-0 p-0 d-flex flex-row justify-content-center align-items-center">
                <Button
                  variant="contained"
                  color="primary"
              ...
              <div className="my-3 mt-2 m-0 p-0 d-flex flex-row justify-content-center align-items-center">
                <Button
                  ...
                  color="primary"
                  onClick={() => {
                    navigate("/compeleted-leitners/false");
                  }}
                  className="w-100 py-3"
                >
                  مشاهده گرامر های تکمیل شده
                </Button>
              </div>
            </div>
          </TabPanel>
