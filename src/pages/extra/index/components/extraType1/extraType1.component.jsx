  ...
  return (
    <div
      ...
      className={
        ...
        " m-0 me-3 p-2 position-relative shadow box-rounded-1 cursor-pointer d-flex flex-column justify-content-start align-items-stretch"
      }
    >
      {isCompleted && (
        <span
